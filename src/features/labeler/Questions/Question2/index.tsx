    ...
    return (
        <div className={commonStyles.question_card} data-inactive={!valid}>
            ...
            <div className={commonStyles.question_card_content}>
                ...
                <Popover placement="top-start" title="简约 Minimalism" trigger="hover" content="以少量的设计元素组合的平面设计形式，常常辅以留白来传达空旷的意境或激发读者的想象。">
                ...
                <Popover placement="top-start" title="科技感 Tech" trigger="hover" content="利用具有科技感的视觉元素，如芯片、电子、通讯、网络、荧光、太空等，营造出先锋、前沿的视觉体验。">
                ...
                <Popover placement="top-start" title="卡通/插画 Cartoon" trigger="hover" content="以手绘作为主要技法的设计形式，通常以夸张的人物或动物作为设计主体。">
                ...
                <Popover placement="top-start" title="现代 Modern" trigger="hover" content="近几年的平面设计流行趋势，更加年轻的设计表达。">
